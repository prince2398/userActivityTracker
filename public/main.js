...
var AdminComponent = /** @class */ (function () {
    ...
    AdminComponent.prototype.ngOnInit = function () {
        ...
        this.dataService.getData(this.id).subscribe(function (user) {
            _this.user = user;
        });
    };
    AdminComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_collect_data_service__WEBPACK_IMPORTED_MODULE_1__["CollectDataService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])
    ], AdminComponent);
...
var NewUserComponent = /** @class */ (function () {
    function NewUserComponent(router, route, collectData) {
        this.router = router;
        this.route = route;
...
var UserComponent = /** @class */ (function () {
    function UserComponent(dataService, route) {
        this.dataService = dataService;
        this.route = route;
    }
